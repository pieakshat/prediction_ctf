...
contract ConditionalTokens is ERC1155 {
    ...
    constructor() ERC1155("https://my-api.com/api/token/{id}.json") {}
    ...
    function splitPosition(
        ...
        if (freeIndexSet == 0) {
            ...
            _burn(
                msg.sender,
                CTHelpers.getPositionId(collateralToken, CTHelpers.getCollectionId(parentCollectionId, conditionId, fullIndexSet ^ freeIndexSet)),
                amount
            );
        }
